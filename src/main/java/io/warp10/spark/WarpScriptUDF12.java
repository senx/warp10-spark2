...
public class WarpScriptUDF12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R> extends WarpScriptAbstractFunction implements UDF12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, R> {

  @Override
  public R call(T1 v1, T2 v2, T3 v3, T4 v4, T5 v5, T6 v6, T7 v7, T8 v8, T9 v9, T10 v10, T11 v11, T12 v12) throws Exception {
    synchronized(this) {
      setCode(v1.toString());
