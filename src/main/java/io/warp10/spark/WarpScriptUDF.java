...
public class WarpScriptUDF<R> extends WarpScriptAbstractFunction {

  public R call(Object... args) throws Exception {
    synchronized(this) {
      setCode(args[0].toString());

      List<Object> stackInput = new ArrayList<Object>(args.length - 1);
      for (int i = 1; i < args.length; i++) {
        stackInput.add(args[i]);
      }
